...
mod tests {
    ...
    mod database {
        ...
        fn test_duplicate_username() {
            ...
            db.create_user("testuser", "test1@example.com", "hash1", "pk1")
                .unwrap();
        ...
        fn test_duplicate_email() {
            ...
            db.create_user("user1", "test@example.com", "hash1", "pk1")
                .unwrap();
        ...
        fn test_get_user_by_username() {
            ...
            db.create_user("findme", "find@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_create_session() {
            ...
            let user_id = db
                .create_user("sessionuser", "s@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_validate_session() {
            ...
            let user_id = db
                .create_user("valuser", "v@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_expired_session() {
            ...
            let user_id = db
                .create_user("expuser", "e@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_create_file() {
            ...
            let user_id = db
                .create_user("fileuser", "f@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_get_file_by_uuid() {
            ...
            let user_id = db
                .create_user("getfileuser", "gf@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_file_tags() {
            ...
            let user_id = db
                .create_user("taguser", "t@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_delete_file() {
            ...
            let user_id = db
                .create_user("deluser", "d@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_create_review() {
            ...
            let user_id = db
                .create_user("reviewer", "r@example.com", "hash", "pk")
                .unwrap();
            let file_uuid = uuid::Uuid::new_v4().to_string();
            let file_id = db
                .create_file(
            ...
            let other_user_id = db
                .create_user("otheruser", "o@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_get_reviews_for_file() {
            ...
            let user_id = db
                .create_user("author", "a@example.com", "hash", "pk")
                .unwrap();
            let file_uuid = uuid::Uuid::new_v4().to_string();
            let file_id = db
                .create_file(
            ...
            for i in 0..3 {
                ...
                db.create_review(
                    ...
                    3 + (i as i32 % 3),
                    &format!(
                        "Review content {} with enough characters to pass validation.",
                        i
                    ),
                    Some(4),
                    Some(4),
        ...
        fn test_increment_view_count() {
            ...
            let user_id = db
                .create_user("viewuser", "view@example.com", "hash", "pk")
                .unwrap();
            let file_uuid = uuid::Uuid::new_v4().to_string();
            db.create_file(
                &file_uuid,
        ...
        fn test_search_files() {
            ...
            let user_id = db
                .create_user("searchuser", "search@example.com", "hash", "pk")
                .unwrap();
        ...
        fn test_popular_tags() {
            ...
            let user_id = db
                .create_user("tagpopuser", "tagpop@example.com", "hash", "pk")
                .unwrap();
